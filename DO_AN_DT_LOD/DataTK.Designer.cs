...
namespace DO_AN_DT_LOD.DataTKTableAdapters {
...
GROUP BY HOADON.sohoadon";
        ...
        public virtual int Fill(DataTK.HOADONDataTable dataTable) {
        ...
        public virtual DataTK.HOADONDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataTK.HOADONDataTable dataTable = new DataTK.HOADONDataTable();
